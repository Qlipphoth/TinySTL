...
void unordered_map_test() {
    ...
    tinystl::unordered_map<int, int> um8(v.begin(), v.end(), 100, tinystl::hash<int>(), tinystl::equal_to<int>());
...
void unordered_multimap_test() {
    ...
    tinystl::unordered_multimap<int, int> um8(v.begin(), v.end(), 100, tinystl::hash<int>(), tinystl::equal_to<int>());
