#ifndef TINYSTL_SET_TEST_H
#define TINYSTL_SET_TEST_H
...
void set_test() {
    ...
    #else
    CON_TEST_P1(set<int>, emplace, rand(), SCALE_SS(LEN1), SCALE_SS(LEN2), SCALE_SS(LEN3));
    #endif
    std::cout << std::endl;
    std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
    PASSED;
...
void multiset_test() {
  ...
  #else
    CON_TEST_P1(multiset<int>, emplace, rand(), SCALE_SS(LEN1), SCALE_SS(LEN2), SCALE_SS(LEN3));
  #endif
    std::cout << std::endl;
    std::cout << "|---------------------|-------------|-------------|-------------|" << std::endl;
    PASSED;
